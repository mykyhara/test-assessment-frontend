...
A live frame-rate badge sits in the top-left of the map. It samples `requestAnimationFrame` the way stats.js does, so a stalled main thread shows up immediately as a number below 60. Switch to the 15k dataset, drag continuously and pinch-zoom — the badge should hold around 60.
